...
所有研究问题记录在 `notes/RESEARCH-LOG.md`，按时间线管理。
...
```
根据研究问题类型，1. 先创建 notes/ 目录（如果不存在）
2. 创建研究日志 notes/RESEARCH-LOG.md（如果不存在）
3. 在研究日志中追加本次研究记录
```
