...
低频读取异环公开列表，保留唯一商品 ID、人民币价格、标题与来源
...
https://www.pxb7.com/buy/10630/1

## 已验证步骤

1. 在本轮命名 task space 复核 www.pxb7.com、页面标题中的异环、权限及验证状态
2. 以当前页上下文读取 selectSearchPageList，gameId 为 10630，query 为 异环；单页不超过 20 条，最多 3 页，价格范围通过 price 筛选传入
