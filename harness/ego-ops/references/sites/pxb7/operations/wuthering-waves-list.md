...
低频读取鸣潮公开列表，保留唯一商品 ID、人民币价格、标题与来源
...
https://www.pxb7.com/buy/10302/1

## 已验证步骤

1. 在本轮命名 task space 复核 www.pxb7.com、页面标题中的鸣潮、权限及验证状态
2. 以当前页上下文读取 selectSearchPageList，gameId 为 10302，query 为 鸣潮；单页不超过 20 条，最多 3 页，价格范围通过 price 筛选传入
3. 按 productId 去重；接口价格单位为分，转换成人民币元；保留 showTitle 与商品 URL

## 检查点

- 页面身份必须为鸣潮，出现登录墙、验证码、风控或用户接管即停止
